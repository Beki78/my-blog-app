  ...
  return <section className='h-screen flex justify-center items-center '>
      <div className='border-solid border-gray-600 border-2 shadow-lg shadow-black p-8 w-96 bg-slate-700 text-white '>
        ...
        <form className='flex flex-col gap-3' >
          ...
          <button className='bg-slate-800 text-white p-2 rounded-sm' type='submit'>Login</button>
        </form>
        <small>Don't have an account? <Link className='underline' to="/register">Signup</Link></small>
